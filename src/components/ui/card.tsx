...
const cardVariants = cva("rounded-xl border text-card-foreground", {
  variants: {
    variant: {
      ...
      gaming: "bg-gradient-to-b from-card to-background border-border shadow-lg",
      glow: "bg-gradient-to-b from-card to-background border-primary/20 shadow-lg shadow-primary/5",
    },
  },
  defaultVariants: {
    variant: "default",
